...
const PlusGPT = (props) => {
    ...
    function handleBuy () {
        ...
        purchase(curPrompt.pid).then(res => {
            setModalOpen(false)
    ...
    function getTypeDefault () {
        const requestBody = {
            type: parseInt(routerParams.type, 10),
            offset: (pageInfo[0] - 1) * pageInfo[1],          //分页查询,第几页
            limit: pageInfo[1]  //分页查询，每页几个
        }
    ...
    return (
        <div className="lower">
            ...
            <div className='chat-left'>
                {/*<div className="box first-box" style={{ height: "15%" }}>*/}
                {/*    <div className="box-header">*/}
                {/*        <TypeContext.Consumer>*/}
                {/*            {type=><span className="box-title">{type}类收藏夹</span>}*/}
                {/*        </TypeContext.Consumer>*/}
                {/*        <input*/}
                ...
                {/*        />*/}
                {/*    </div>*/}
                {/*    <div className="box-content">Box 1 content</div>*/}
                {/*</div>*/}
                ...
                <div className="box" style={{ height: "100%" }}>
                    ...
                    <div className="box-content">
                        {/*{showPrompt.map((item, index) => <PromptCard onClick={() => handleSelectPrompt(item)} props={item} key={index}></PromptCard>)}*/}
                        {/*<Pagination  simple*/}
                        {/*    defaultCurrent={1}*/}
                        {/*    total={total} pageSize={pageInfo[1]}*/}
                ...
                {/*    <div className="box-header">*/}
                {/*        <span className="box-title">收藏夹</span>*/}
                {/*        <input*/}
                {/*            className="search-bar"*/}
                {/*            type="text"*/}
                {/*            placeholder="Search"*/}
                {/*        />*/}
                {/*    </div>*/}
                {/*    <div className="box-content">Box 3 content</div>*/}
                {/*</div>*/}
                ...
                <div className="chat-window">
                    ...
                    {usePrompt ? (<div className="prompt-use-card">
                        <div className="prompt-use-info">
                            ...
                            {/*<Close fill="white" className="close-prompt" onClick={setUsePrompt(false)} />*/}
                        </div>
